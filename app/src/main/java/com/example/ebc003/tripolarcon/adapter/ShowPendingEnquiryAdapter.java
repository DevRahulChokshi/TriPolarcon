...
public class ShowPendingEnquiryAdapter extends RecyclerView.Adapter<ShowPendingEnquiryAdapter.LogHolder>{

    Context context;
    List<LogData> mLogList;
    LayoutInflater layoutInflater;
    private String TAG=ShowPendingEnquiryAdapter.class.getSimpleName ();

    public ShowPendingEnquiryAdapter (Context context, List<LogData> mLogList) {
